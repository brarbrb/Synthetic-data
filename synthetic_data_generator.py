...
"""
    This file is identical to the file in Part1/additional_rendering.py
    We advise to use  rm -rf .bproc_cache to clean cache between runs
    If you early stop the execution of this file - use   pkill -9 -f blender
        otherwise the blenderproc will keep runing in the background and eating out your RAM :((
"""

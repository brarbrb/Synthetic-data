...
def main():
    ...
    ap.add_argument("--coco", default="out/val/coco_keypoints.json", help="Path to COCO JSON")
    ap.add_argument("--images_root", default="out/val", help="Root folder containing the image files")
    ap.add_argument("--image_file", default="images/000000.png",
